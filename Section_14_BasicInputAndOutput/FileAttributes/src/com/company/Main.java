...
//            Files.createFile(fileToCreate); // creating a file
//            Path dirToCreate = FileSystems.getDefault().getPath("Examples", "Dir4");
//            Files.createDirectory(dirToCreate); // creating a directory
...
//            Path filePath = FileSystems.getDefault().getPath("Examples", "Dir1/file1.txt");
            Path filePath = FileSystems.getDefault().getPath("Examples", "Dir1\\file1.txt");
            long size = Files.size(filePath); // size of the file
            System.out.println("Size = " + size);
            System.out.println("Last modified =  " + Files.getLastModifiedTime(filePath)); // last time the file was modified


            BasicFileAttributes attrs = Files.readAttributes(filePath, BasicFileAttributes.class); // file attributes
