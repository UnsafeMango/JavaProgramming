...
public class CopyFiles extends SimpleFileVisitor<Path> {
    ...
    public FileVisitResult preVisitDirectory(Path dir, BasicFileAttributes attrs) throws IOException {
        ...
        Path relativizedPath = sourceRoot.relativize(dir); //.relativized() constructs a relative part that resolves to a given path
        ...
        try {
            Files.copy(dir, copyDir);//copy the file
        } catch(IOException e) {
